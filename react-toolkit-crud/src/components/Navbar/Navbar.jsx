...
const Navbar = () => {
  ...
  return (
    <div className="w-full py-5 absolute z-30 container-full mx-auto px-10 ">
      <div className="flex justify-between">
        ...
        <ul
          ...
          } h-screen md:h-auto w-[50vw] md:w-auto flex flex-col md:flex-row justify-center md:flex md:bg-transparent  transition ease-in-out duration-200`}
        >
          <GrClose
            onClick={() => setIsToggled(!isToggled)}
